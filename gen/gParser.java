...
public class gParser extends Parser {
	...
	public static final int
		...
		T__17=18, T__18=19, T__19=20, T__20=21, FUNCTION_NAME=22, INT_TYPE=23, 
		CHAR_TYPE=24, STRING_TYPE=25, DOUBLE_TYPE=26, FLOAT_TYPE=27, BOOL_TYPE=28, 
		ID=29, NUMBER=30, CHAR=31, DOBULE=32, STRING=33, P_STRING=34, BOOL=35, 
		WS=36;
	public static final int
		...
		RULE_j_type = 19, RULE_j_loop = 20, RULE_statement = 21, RULE_whileStatement = 22, 
		RULE_conditionStatement = 23, RULE_forStatement = 24, RULE_basicForStatement = 25, 
		RULE_stmt = 26, RULE_block = 27, RULE_forInit = 28, RULE_localVariableDeclaration = 29, 
		RULE_forUpdate = 30, RULE_expression = 31, RULE_condition = 32, RULE_incDecExpression = 33, 
		RULE_p_forloop = 34, RULE_p_exp = 35, RULE_p_list = 36, RULE_p_type = 37, 
		RULE_p_range = 38;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"j_type", "j_loop", "statement", "whileStatement", "conditionStatement", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "';'", "'('", "')'", "'()'", "','", "'='", "'['", "']'", "'while'", 
			"'for'", "'{'", "'}'", "'>'", "'<'", "'>='", "'<='", "'++'", "'--'", 
			"'in'", "':'", "'range'", null, "'int'", "'char'", "'String'", "'double'", 
			"'float'", "'boolean'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, "FUNCTION_NAME", 
			"INT_TYPE", "CHAR_TYPE", "STRING_TYPE", "DOUBLE_TYPE", "FLOAT_TYPE", 
			"BOOL_TYPE", "ID", "NUMBER", "CHAR", "DOBULE", "STRING", "P_STRING", 
			"BOOL", "WS"
		};
	}
	...
	public final JavaContext java() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 532678144L) != 0) {
				{
				{
				setState(84);
				j_line();
	...
	public final PythonContext python() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 541066240L) != 0) {
				{
				{
				setState(90);
				p_line();
	...
	public final J_loopContext j_loop() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_j_loop);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(212);
	...
	public final ConditionStatementContext conditionStatement() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_conditionStatement);
		try {
			setState(229);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final BasicForStatementContext basicForStatement() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_basicForStatement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 537264128L) != 0) {
				{
				setState(243);
				forUpdate();
				}
	...
	public final P_forloopContext p_forloop() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_p_forloop);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final P_expContext p_exp() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_p_exp);
		try {
			setState(299);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final P_listContext p_list() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_p_list);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 44023414784L) != 0) {
				{
				setState(302);
				p_type();
				setState(307);
	...
	public final P_typeContext p_type() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_p_type);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final P_rangeContext p_range() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_p_range);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(316);
