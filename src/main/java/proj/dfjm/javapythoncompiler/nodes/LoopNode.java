...
public class LoopNode extends GrammarNode {

    public LoopNode(IWorkflowPatternBuilder workflowPatternBuilder) {
    ...
    public IWorkflowPatternBuilder getPatternBuilder(int tabNumber) {
        ...
        return  workflowPatternBuilder.setTabNumber(tabNumber)
                .appendLoop(firstArgument, secondArgument, thirdArgument, fourthArgument);
    }
}
